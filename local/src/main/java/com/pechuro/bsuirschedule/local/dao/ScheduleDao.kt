...
interface ScheduleDao {
    ...
    fun insert(values: ScheduleDB): Long

    @Update
    fun update(schedule: ScheduleDB)

    @Insert(onConflict = OnConflictStrategy.IGNORE)
    fun insert(values: List<ScheduleItemDB>)
    ...
    fun get(name: String, type: Int): Observable<List<ScheduleItemDB>>
    ...
    fun get(name: String, type: Int, day: String): Observable<List<ScheduleItemDB>>
    ...
    fun get(name: String, type: Int, day: String, week: String): Observable<List<ScheduleItemDB>>
    ...
    fun get(name: String, type: Int, day: String, subgroups: Array<Int>): Observable<List<ScheduleItemDB>>
    ...
    fun get(name: String, type: Int, day: String, week: String, subgroups: Array<Int>): Observable<List<ScheduleItemDB>>
    ...
    fun getSchedules(): Observable<List<ScheduleDB>>

    @Query("SELECT * FROM all_schedules WHERE type = 1 OR type = 2")
    fun getStudentSchedules(): Single<List<ScheduleDB>>*/
}