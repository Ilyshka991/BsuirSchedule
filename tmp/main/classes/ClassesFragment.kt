...
import com.pechuro.bsuirschedule.widget.listeners.ViewPagerListener
...
import com.pechuro.bsuirschedule.feature.main.datepickerdialog.DatePickerEvent
...
class ClassesFragment : BaseFragment<FragmentViewpagerBinding, ClassesFragmentViewModel>() {
    ...
    private var viewType: Int by com.pechuro.bsuirschedule.local.preferences.PrefsDelegate(VIEW_TYPE, VIEW_TYPE_DAY)
