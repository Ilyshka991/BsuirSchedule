...
import com.pechuro.bsuirschedule.feature.add.addschedule.fragment.SuggestionItemInformation.Companion.TYPE_EMPLOYEE
import com.pechuro.bsuirschedule.feature.add.addschedule.fragment.SuggestionItemInformation.Companion.TYPE_GROUP
...
class AddScheduleSuggestionsAdapter : ListAdapter<SuggestionItemInformation, BaseViewHolder<SuggestionItemInformation>>(DIFF_CALLBACK) {
    ...
    private val onClickListener = View.OnClickListener {
        val info = it.tag as? SuggestionItemInformation ?: return@OnClickListener
        onItemClicked(info)
    }
